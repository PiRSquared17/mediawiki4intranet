...
HTML;
    ...
    $content .= <<<HTML
        ...
        $hacl_rightsPanel_3
            ...
            <div class="haloacl_panel_content_row_content">
                <input type="text" disabled="true" style="width:700px" id="right_description_$panelid" value="$description" />
            </div>
        </div>
 ...
 * @param <string> group, which will be expanded
 * @param <string> search-string from filter
 * @param <boolean> load all groups recursively (no dynamic loading)
 * @param <integer> internaly used indicator for recursion-level
 * @param <array> internally used array for recursion
 * @return <string> json-formed list of groups
 */
...
HTML;
    ...
    $panelContent = <<<HTML
        ...
        $hacl_manageUser_6<span style="margin-right:20px;float:right">$delete_text</span><span style="margin-right:26px;float:right">Edit</span><span style="margin-right:29px;float:right">Info</span>
                </div>
                <div id="haloacl_manageuser_contentlist_title">
...
HTML;
   ...
   <div id="content_haloacl_quicklist_panel">
        ...
        $hacl_quickACL_3<span style="margin-right:20px;float:right;">$select_text</span><span style="margin-right:25px;float:right;">Info</span>
            ...
            <div style="clear:both;border:1px solid;border-style:solid none none none;text-align:right;padding:3px 6px">
                <span style="padding:4px 0 0 6px" class="haloacl_cont_under_trees">
...
function haclDoesArticleExists($articlename,$protect) {
    global $haclgContLang, $wgContLang, $wgCanonicalNamespaceNames;
    ...
    if($protect == "namespace") {
        ...
        if(strtolower(trim($articlename)) == 'main')
            $articlename = 0;
        else
            $articlename = $wgContLang->getNsIndex($articlename);

        if($articlename || $articlename === 0) {
            $articlename = $articlename ? $wgContLang->getNsText($articlename) : 'Main';
