...
If you want to protect some pages, ACL page must be named as one of: ACL:Page/*, ACL:Category/*, ACL:Namespace/*, ACL:Property/*, ACL:Right/*, ACL:Template/*.',
    ...
    'hacl_autocomplete_no_sd/rights'    => 'No right templates found',
    ...
    'hacl_edit_define_rights'           => 'Error: ACL must include rights!',
    'hacl_edit_define_manager'          => 'Error: ACL must have managers!',
    ...
    'hacl_action_owntemplate'           => 'Edit own default template',
    ...
    'hacl_quickaccess_filter_sds'       => 'Filter templates by name',
    'hacl_quickaccess_filter'           => 'Name starts with:',
    'hacl_quickaccess_filter_submit'    => 'Apply',
    'hacl_quickaccess_manage'           => 'HaloACL: Manage Quick Access list',
    'hacl_quickaccess_manage_text'      => 'This is a list of all the ACL templates that you can use in your quick access list.<br />This list defines the ACLs that will be in the dropdown box that is on the top of every page in the edit or creation mode.',
    'hacl_quickaccess_save'             => 'Save selections',
    'hacl_quickaccess_hint'             => 'Select some ACL templates and then click Save selections:',
    'hacl_quickaccess_own_template'     => '(your default template is always present in Quick ACL list)',
    'hacl_quickaccess_empty'            => 'There are no ACL templates available for Quick Access. Create one using <b>Create new ACL definition</b>.',
    ...
    'hacl_grp_creating'                 => 'Creating group',
    'hacl_grp_editing'                  => 'Editing group: $1',
