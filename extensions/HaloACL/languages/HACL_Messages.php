...
If you want to protect some pages, ACL page must be named as one of: ACL:Page/*, ACL:Category/*, ACL:Namespace/*, ACL:Property/*, ACL:Right/*, ACL:Template/*.',
    ...
    'hacl_edit_ahint_manage'            => 'This is the right to change SDs of pages within given category/namespace/used template. It is inherited by pages.',
    'hacl_edit_ahint_template'          => 'This is the non-inheritable manage right.',
